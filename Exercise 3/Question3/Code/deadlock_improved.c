/**
* @file deadlock_improved.c
* @brief This code implements a deadlock-free function by improving the deadlock.c code. Credit: Dr. Sam Siewart
* @author Sowmya Ramakrishnan and Vikrant Waje
* @date March 07, 2018
*
*/
...
void *grabRsrcs(void *threadid)
{
   ...
   {
     usleep(2000000);   //The random backoff time time added in thread 2 
